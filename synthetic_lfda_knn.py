...
for i in range(1,11):
    ...
    lmnn_knn = Pipeline(steps=[('lfda', LFDA()), ('knn', KNeighborsClassifier())])
    parameters = {'lfda__k':[1,2,3,4,5,6,7,8,9], 'knn__n_neighbors':[1,2,3,4,5,6,7,8]}
...
fig.set_dpi(100)
st = fig.suptitle("LFDA to KNN", fontsize="x-large")
...
fig.savefig("synthetic_lfda_1000_knn.png")